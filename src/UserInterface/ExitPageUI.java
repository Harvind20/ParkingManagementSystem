...
import coreParkingSystem.VehicleDAO; // Added Import
import java.awt.*;
...
public class ExitPageUI extends JFrame {
    ...
    private void performSearch() {
        ...
        // Use VehicleDAO to get the type properly
        VehicleDAO vehicleDAO = new VehicleDAO();
        String realType = vehicleDAO.getVehicleType(currentExitData.getLicensePlate());
        lblVehicle.setText("Vehicle Type: " + realType);
